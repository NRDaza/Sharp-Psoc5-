// ======================================================================
// ADC_sharp.v generated from TopDesign.cysch
// 02/15/2019 at 16:02
...
// CharLCDmp_v1_2(ConversionRoutines=true, CUSTOM0="8,4,2,4,8,0,A,0,", CUSTOM1="0,A,A,4,4,4,0,0,", CUSTOM2="0,E,A,E,8,8,0,0,", CUSTOM3="0,E,A,C,A,A,0,0,", CUSTOM4="0,E,8,C,8,E,0,0,", CUSTOM5="0,E,8,E,2,E,0,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCDmp_v1_2, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=2, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LCD, )
...
module top ;
	...
	wire [0:0] tmpOE__Sharp_net;
	wire [0:0] tmpFB_0__Sharp_net;
	wire [0:0] tmpIO_0__Sharp_net;
	wire [0:0] tmpINTERRUPT_0__Sharp_net;
	electrical [0:0] tmpSIOVREF__Sharp_net;
	...
	cy_psoc3_pins_v1_10
		...
		Sharp
		 (.oe(tmpOE__Sharp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sharp_net[0:0]}),
		  .analog({Net_8}),
		  .io({tmpIO_0__Sharp_net[0:0]}),
		  .siovref(tmpSIOVREF__Sharp_net),
		  .interrupt({tmpINTERRUPT_0__Sharp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sharp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4b614967-2f93-44b3-8c32-45c25e973d89"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("67680b8b-1723-481e-9c1f-3b4dde6e1f3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a364b2f0-7554-41ce-8828-9188f575c42f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ca41ea4d-bde0-4d7b-8f93-8474bbe24088"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b2727809-c681-4d4e-8870-64c72a04aec8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
